...
class SignupActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            signupRepository = Injection.provideSignupRepository(applicationContext)
        }
    ...
    private fun setupAction() {
        ...
        binding.signupButton.setOnClickListener {
            ...
            if (checkInput(name, email, phonenumbertext, password, confirmPassword, enteredText)) {
                binding.progressBar.visibility = View.VISIBLE
                lifecycleScope.launch {
                    try {
                        val response = signupRepository.register(name, email, fullphonenumber, password, confirmPassword, selectedCityId)
    ...
    private fun checkInput(name: String, email: String, phonenumber: String, password: String, confirmPassword: String, city: String): Boolean {
    ...
    private fun playAnimation() {
        ...
        val cityview = ObjectAnimator.ofFloat(binding.autoCompleteTextView, View.ALPHA, 1f).setDuration(100)
